...
import { filtradoAdministradorDTO } from 'src/app/Models/Capm/CapmTipoRespuesta';
import { AlertaService } from 'src/app/shared/Services/Alerta/alerta.service';
import { CapmAdministrarUsuariosService } from 'src/app/shared/Services/Capm/Capm-Administrar-Usuarios/capm-administrar-usuarios.service';
@Component({
  selector: 'app-capm-administrar-usuarios',
  templateUrl: './capm-administrar-usuarios.component.html',
  styleUrls: ['./capm-administrar-usuarios.component.scss']
})
export class CapmAdministrarUsuariosComponent implements OnInit {

  constructor(
    public _CapmAdministrarUsuarios:CapmAdministrarUsuariosService,
  ...
  public EnvioAcceso: CapmAdministrarUsuariosAccesoDTO={
  ...
  ngOnInit(): void {
    this.ObtenerReporteAdministrarUsuarioResumenCapm();
  }
  ObtenerReporteAdministrarUsuarioResumenCapm(){
    ...
    this._CapmAdministrarUsuarios.ObtenerReporteAdministrarUsuarioResumenCapm().subscribe({
      next: (x: any) => {
        console.log(x)
  ...
  ObtenerReporteAdministrarUsuarioPorCodigoMatriculaCapm(CodigoMatricula:string){
    this.listOfDisplayData=undefined;
    this.DisabledDescargaExcel=true;
    ...
    this._CapmAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCodigoMatriculaCapm(this.CodigoMatriculaBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
...
if(e.fechaCaducidadSimulador!=undefined && e.fechaCaducidadSimulador!=null){
  ...
  ObtenerReporteAdministrarUsuarioPorCentroCostosCapm(CentroCostos:string){
    this.listOfDisplayData=undefined;
    this.DisabledDescargaExcel=true;
    var datePipe = new DatePipe('en-US');
    this.editarReporte=false;
    ...
    this._CapmAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCentroCostosCapm(this.CentroCostosBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
...
if(e.fechaCaducidadSimulador!=undefined && e.fechaCaducidadSimulador!=null){
  ...
  GuardarCambios(data:any){
    ...
    this.EnvioAcceso.idTipoSimuladorWeb = 2;
    ...
    this._CapmAdministrarUsuarios.GuardarCambiosAccesoSimuladorCapm(this.EnvioAcceso).subscribe({
      next: (x: any) => {
