...
import { CapmModalAgregarSubcategoriaComponent } from './capm-modal-agregar-subcategoria/capm-modal-agregar-subcategoria.component';
import { CapmModalAgregarCategoriaComponent } from './capm-modal-agregar-categoria/capm-modal-agregar-categoria.component';
...
import { filtro } from 'src/app/Models/Capm/CapmTipoRespuesta';

@Component({
  selector: 'app-capm-configuracion-categorias',
  templateUrl: './capm-configuracion-categorias.component.html',
  styleUrls: ['./capm-configuracion-categorias.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class CapmConfiguracionCategoriasComponent implements OnInit {
  displayedColumns: string[] = ['id', 'nombre', 'cantidad', 'proporcion'];

  constructor(
    public dialog: MatDialog,
    private _TipoDominio: CapmCategoriasService,
  ...
  agregar() {
    this.isNew = false;
    const dialogRef = this.dialog.open(CapmModalAgregarCategoriaComponent, {
      width: '60%',
