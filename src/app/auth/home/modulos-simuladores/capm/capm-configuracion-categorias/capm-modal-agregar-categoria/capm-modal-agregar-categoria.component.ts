...
@Component({
  selector: 'app-capm-modal-agregar-categoria',
  templateUrl: './capm-modal-agregar-categoria.component.html',
  styleUrls: ['./capm-modal-agregar-categoria.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class CapmModalAgregarCategoriaComponent implements OnInit {

  constructor(
    public dialogRef: MatDialogRef<CapmModalAgregarCategoriaComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private alertaService: AlertaService,
    private formBuilder: FormBuilder,
    private _Dominio: CapmCategoriasService
  ) { }
  ...
  public jsonEnvio:CapmPreguntaDTO = {
    Nombre: 'Prueba',
  ...
  public jsonActualizar:CapmPreguntaActualizarDTO = {
    Id: 0,
    Nombre: 'Prueba',
    CantidadPreguntasPorExamen: 5,
    CantidadTotal: 5,
