...
public jsonActualizar:CapmActualizarTareaDTO = {
  ...
  ngOnInit(): void {
    ...
    if(this.data!=undefined)
    {
      ...
      this.formCategoria.get('IdCategoria')?.setValue(this.data[0].idSimuladorCapmDominio)
  ...
  Agregar(){
    ...
    this.jsonEnvio.IdSimuladorCapmDominio = this.formCategoria.get('IdCategoria')?.value
  ...
  Editar(){
    ...
    this.jsonActualizar.IdSimuladorCapmDominio = this.formCategoria.get('IdCategoria')?.value
