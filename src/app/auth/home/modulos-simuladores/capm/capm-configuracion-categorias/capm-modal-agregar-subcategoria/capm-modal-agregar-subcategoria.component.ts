...
@Component({
  selector: 'app-capm-modal-agregar-subcategoria',
  templateUrl: './capm-modal-agregar-subcategoria.component.html',
  styleUrls: ['./capm-modal-agregar-subcategoria.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class CapmModalAgregarSubcategoriaComponent implements OnInit {

  constructor(
    public dialogRef: MatDialogRef<CapmModalAgregarSubcategoriaComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private formBuilder: FormBuilder,
    private alertaService: AlertaService,
    private _Tarea: CapmTareaService,
...
public jsonEnvio:CapmAgregarTareaDTO = {
...
public jsonActualizar:CapmActualizarTareaDTO = {
  Id:0,
  IdSimuladorCapmDominio: 0,
  Nombre: '',
  CantidadPreguntasPorExamen: 0,
  ...
  ngOnInit(): void {
    ...
    if(this.data!=undefined)
    {
      ...
      this.formSubCategoria.get('IdCategoria')?.setValue(this.data[0].idSimuladorCapmDominio)
  ...
  Agregar(){
    ...
    this.jsonEnvio.IdSimuladorCapmDominio = this.formSubCategoria.get('IdCategoria')?.value
  ...
  Editar(){
    ...
    this.jsonActualizar.IdSimuladorCapmDominio = this.formSubCategoria.get('IdCategoria')?.value
