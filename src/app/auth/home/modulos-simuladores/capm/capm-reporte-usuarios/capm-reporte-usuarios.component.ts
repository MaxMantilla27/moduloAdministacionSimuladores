...
import { CapmAbrirModalDetalleExamenComponent } from './capm-abrir-modal-detalle-examen/capm-abrir-modal-detalle-examen.component';

@Component({
  selector: 'app-capm-reporte-usuarios',
  templateUrl: './capm-reporte-usuarios.component.html',
  styleUrls: ['./capm-reporte-usuarios.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class CapmReporteUsuariosComponent implements OnInit {
  ...
  VerExamen(IdExamen:number){
    const dialogRef = this.dialog.open(CapmAbrirModalDetalleExamenComponent, {
      width: '100%',
      height: '100%',
      maxHeight: '95%',
      maxWidth: '100%',
