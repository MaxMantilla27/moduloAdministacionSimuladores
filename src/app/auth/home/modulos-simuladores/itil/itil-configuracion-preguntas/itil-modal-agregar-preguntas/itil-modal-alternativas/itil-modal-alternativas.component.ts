...
@Component({
  selector: 'app-itil-modal-alternativas',
  templateUrl: './itil-modal-alternativas.component.html',
  styleUrls: ['./itil-modal-alternativas.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ItilModalAlternativasComponent implements OnInit {

  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    public dialogRef: MatDialogRef<ItilModalAlternativasComponent>,
  ...
  public ActualizarAlternativaDTO: ItilPreguntaRespuestaEnvioDTO={
    Id:0,
    Respuesta:'',
    Correcto:false,
    Puntaje:0,
  ...
  public AgregarAlternativaDTO: ItilPreguntaRespuestaEnvioAgregarDTO = {
    Id:0,
    Respuesta:'',
    Correcto:false,
    Puntaje:0,
  ...
  EnviarRegistrosAlternativas(){
    ...
    if(this.data[3]== undefined ){
      this.AgregarAlternativaDTO.IdSimuladorItilPregunta = 0
    }
    else{
      this.AgregarAlternativaDTO.IdSimuladorItilPregunta = this.data[3]
    }


    this._alternativa.AgregarItilPreguntaRespuesta(this.AgregarAlternativaDTO).subscribe({
      next: (x:any) => {
        console.log(x)
  ...
  ActualizarAlternativa(){
    ...
    this._alternativa.ActualizarItilPreguntaRespuesta(this.ActualizarAlternativaDTO).subscribe({
      next: (x:any) => {
        console.log(x)
