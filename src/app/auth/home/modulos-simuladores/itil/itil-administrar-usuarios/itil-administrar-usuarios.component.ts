...
import { filtradoAdministradorDTO } from 'src/app/Models/Itil/ItilTipoRespuesta';
import { AlertaService } from 'src/app/shared/Services/Alerta/alerta.service';
import { ItilAdministrarUsuariosService } from 'src/app/shared/Services/Itil/Itil-Administrar-Usuarios/itil-administrar-usuarios.service';
@Component({
  selector: 'app-itil-administrar-usuarios',
  templateUrl: './itil-administrar-usuarios.component.html',
  styleUrls: ['./itil-administrar-usuarios.component.scss']
})
export class ItilAdministrarUsuariosComponent implements OnInit {

  constructor(
    public _ItilAdministrarUsuarios:ItilAdministrarUsuariosService,
  ...
  public EnvioAcceso: ItilAdministrarUsuariosAccesoDTO={
  ...
  ngOnInit(): void {
    this.ObtenerReporteAdministrarUsuarioResumenItil();
  }
  ObtenerReporteAdministrarUsuarioResumenItil(){
    ...
    this._ItilAdministrarUsuarios.ObtenerReporteAdministrarUsuarioResumenItil().subscribe({
      next: (x: any) => {
        console.log(x)
  ...
  ObtenerReporteAdministrarUsuarioPorCodigoMatriculaItil(CodigoMatricula:string){
    this.listOfDisplayData=undefined;
    this.DisabledDescargaExcel=true;
    ...
    this._ItilAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCodigoMatriculaItil(this.CodigoMatriculaBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
...
if(e.fechaCaducidadSimulador!=undefined && e.fechaCaducidadSimulador!=null){
  ...
  ObtenerReporteAdministrarUsuarioPorCentroCostosItil(CentroCostos:string){
    this.listOfDisplayData=undefined;
    this.DisabledDescargaExcel=true;
    var datePipe = new DatePipe('en-US');
    this.editarReporte=false;
    ...
    this._ItilAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCentroCostosItil(this.CentroCostosBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
...
if(e.fechaCaducidadSimulador!=undefined && e.fechaCaducidadSimulador!=null){
  ...
  GuardarCambios(data:any){
    ...
    this.EnvioAcceso.idTipoSimuladorWeb = 3;
    ...
    this._ItilAdministrarUsuarios.GuardarCambiosAccesoSimuladorItil(this.EnvioAcceso).subscribe({
      next: (x: any) => {
