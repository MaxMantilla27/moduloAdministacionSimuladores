...
@Component({
  selector: 'app-itil-modal-agregar-subcategoria',
  templateUrl: './itil-modal-agregar-subcategoria.component.html',
  styleUrls: ['./itil-modal-agregar-subcategoria.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class ItilModalAgregarSubcategoriaComponent implements OnInit {

  constructor(
    public dialogRef: MatDialogRef<ItilModalAgregarSubcategoriaComponent>,
...
public jsonEnvio:ItilAgregarTareaDTO = {
...
public jsonActualizar:ItilActualizarTareaDTO = {
  Id:0,
  IdSimuladorItilDominio: 0,
  Nombre: '',
  CantidadPreguntasPorExamen: 0,
  ...
  ngOnInit(): void {
    ...
    if(this.data!=undefined)
    {
      ...
      this.formSubCategoria.get('IdCategoria')?.setValue(this.data[0].idSimuladorItilDominio)
  ...
  Agregar(){
    ...
    this.jsonEnvio.IdSimuladorItilDominio = this.formSubCategoria.get('IdCategoria')?.value
  ...
  Editar(){
    ...
    this.jsonActualizar.IdSimuladorItilDominio = this.formSubCategoria.get('IdCategoria')?.value
