...
public jsonActualizar:ItilActualizarTareaDTO = {
  ...
  ngOnInit(): void {
    ...
    if(this.data!=undefined)
    {
      ...
      this.formCategoria.get('IdCategoria')?.setValue(this.data[0].idSimuladorItilDominio)
  ...
  Agregar(){
    ...
    this.jsonEnvio.IdSimuladorItilDominio = this.formCategoria.get('IdCategoria')?.value
  ...
  Editar(){
    ...
    this.jsonActualizar.IdSimuladorItilDominio = this.formCategoria.get('IdCategoria')?.value
