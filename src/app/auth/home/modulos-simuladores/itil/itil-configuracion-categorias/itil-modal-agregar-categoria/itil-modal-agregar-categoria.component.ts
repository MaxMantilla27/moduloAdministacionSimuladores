...
import { ItilPreguntaActualizarDTO, ItilPreguntaDTO } from 'src/app/Models/Itil/ItilPreguntaDTO';
import { AlertaService } from 'src/app/shared/Services/Alerta/alerta.service';
import { ItilCategoriasService } from 'src/app/shared/Services/Itil/Itil-Categorias/itil-categorias.service';

@Component({
  selector: 'app-itil-modal-agregar-categoria',
  templateUrl: './itil-modal-agregar-categoria.component.html',
  styleUrls: ['./itil-modal-agregar-categoria.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class ItilModalAgregarCategoriaComponent implements OnInit {

  constructor(
    public dialogRef: MatDialogRef<ItilModalAgregarCategoriaComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private alertaService: AlertaService,
    private formBuilder: FormBuilder,
    private _Dominio: ItilCategoriasService
  ) { }
  ...
  public fileErrorMsg=''
  public jsonEnvio:ItilPreguntaDTO = {
    Nombre: '',
  ...
  public jsonActualizar:ItilPreguntaActualizarDTO = {
    Id: 0,
    Nombre: '',
    CantidadPreguntasPorExamen: 0,
    CantidadTotal: 0,
