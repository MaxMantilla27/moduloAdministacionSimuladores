...
import { filtradoAdministradorDTO } from 'src/app/Models/Pbi/PbiTipoRespuesta';
import { AlertaService } from 'src/app/shared/Services/Alerta/alerta.service';
import { PbiAdministrarUsuariosService } from 'src/app/shared/Services/Pbi/Pbi-Administrar-Usuarios/pbi-administrar-usuarios.service';
@Component({
  selector: 'app-pbi-administrar-usuarios',
  templateUrl: './pbi-administrar-usuarios.component.html',
  styleUrls: ['./pbi-administrar-usuarios.component.scss']
})
export class PbiAdministrarUsuariosComponent implements OnInit {

  constructor(
    public _PbiAdministrarUsuarios:PbiAdministrarUsuariosService,
  ...
  public EnvioAcceso: PbiAdministrarUsuariosAccesoDTO={
  ...
  ObtenerReporteAdministrarUsuarioResumenPbi(){
    ...
    this._PbiAdministrarUsuarios.ObtenerReporteAdministrarUsuarioResumenPbi().subscribe({
      next: (x: any) => {
        console.log(x)
  ...
  ObtenerReporteAdministrarUsuarioPorCodigoMatriculaPbi(CodigoMatricula:string){
    ...
    this._PbiAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCodigoMatriculaPbi(this.CodigoMatriculaBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
...
if(e.fechaCaducidadSimulador!=undefined && e.fechaCaducidadSimulador!=null){
  ...
  ObtenerReporteAdministrarUsuarioPorCentroCostosPbi(CentroCostos:string){
    ...
    this._PbiAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCentroCostosPbi(this.CentroCostosBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
...
if(e.fechaCaducidadSimulador!=undefined && e.fechaCaducidadSimulador!=null){
  ...
  GuardarCambios(data:any){
    ...
    this.EnvioAcceso.idTipoSimuladorWeb = 13;
    ...
    this._PbiAdministrarUsuarios.GuardarCambiosAccesoSimuladorPbi(this.EnvioAcceso).subscribe({
      next: (x: any) => {
