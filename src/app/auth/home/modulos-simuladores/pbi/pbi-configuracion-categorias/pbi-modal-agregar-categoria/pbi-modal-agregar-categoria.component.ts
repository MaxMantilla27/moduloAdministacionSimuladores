...
import { pbiPreguntaActualizarDTO, pbiPreguntaDTO } from 'src/app/Models/Pbi/PbiPreguntaDTO';
...
@Component({
  selector: 'app-pbi-modal-agregar-categoria',
  templateUrl: './pbi-modal-agregar-categoria.component.html',
  styleUrls: ['./pbi-modal-agregar-categoria.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class PbiModalAgregarCategoriaComponent implements OnInit {

  constructor(
    public dialogRef: MatDialogRef<PbiModalAgregarCategoriaComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private alertaService: AlertaService,
    private formBuilder: FormBuilder,
    private _Dominio: PbiCategoriasService
  ) { }
  ...
  public jsonEnvio: pbiPreguntaDTO = {
    Nombre: 'Prueba',
  ...
  public jsonActualizar:pbiPreguntaActualizarDTO = {
    Id: 0,
    Nombre: 'Prueba',
    CantidadPreguntasPorExamen: 5,
    CantidadTotal: 5,
