...
import { filtro } from 'src/app/Models/Pbi/PbiTipoRespuesta';
...
import { PbiModalAgregarCategoriaComponent } from './pbi-modal-agregar-categoria/pbi-modal-agregar-categoria.component';

@Component({
  selector: 'app-pbi-configuracion-categorias',
  templateUrl: './pbi-configuracion-categorias.component.html',
  styleUrls: ['./pbi-configuracion-categorias.component.scss']
})
export class PbiConfiguracionCategoriasComponent implements OnInit {

  displayedColumns: string[] = ['id', 'nombre', 'cantidad', 'proporcion'];

  constructor(
    public dialog: MatDialog,
    private _TipoDominio: PbiCategoriasService,
    private _tarea: PbiTareaService,
  ...
  openDialogSub() {
    const dialogRef = this.dialog.open(PbiModalAgregarCategoriaComponent, {
      width: '1000px',
      maxHeight: '90vh',
