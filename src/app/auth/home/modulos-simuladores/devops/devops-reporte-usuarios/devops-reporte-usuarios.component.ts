...
import { DevopsAbrirModalDetalleExamenComponent } from './devops-abrir-modal-detalle-examen/devops-abrir-modal-detalle-examen.component';

@Component({
  selector: 'app-devops-reporte-usuarios',
  templateUrl: './devops-reporte-usuarios.component.html',
  styleUrls: ['./devops-reporte-usuarios.component.scss']
})
export class DevopsReporteUsuariosComponent implements OnInit {
  ...
  VerExamen(IdExamen:number){
    const dialogRef = this.dialog.open(DevopsAbrirModalDetalleExamenComponent, {
      width: '100%',
      height: '100%',
      maxHeight: '95%',
      maxWidth: '100%',
