...
import { filtradoAdministradorDTO } from 'src/app/Models/Devops/DevopsTipoRespuesta';
import { AlertaService } from 'src/app/shared/Services/Alerta/alerta.service';
import { DevopsAdministrarUsuariosService } from 'src/app/shared/Services/Devops/Devops-Administrar-Usuarios/devops-administrar-usuarios.service';

@Component({
  selector: 'app-devops-administrar-usuarios',
  templateUrl: './devops-administrar-usuarios.component.html',
  styleUrls: ['./devops-administrar-usuarios.component.scss']
})
export class DevopsAdministrarUsuariosComponent implements OnInit {

  constructor(
    public _DevopsAdministrarUsuarios:DevopsAdministrarUsuariosService,
  ...
  public EnvioAcceso: DevopsAdministrarUsuariosAccesoDTO={
  ...
  ObtenerReporteAdministrarUsuarioResumen(){
    ...
    this._DevopsAdministrarUsuarios.ObtenerReporteAdministrarUsuarioResumen().subscribe({
      next: (x: any) => {
        console.log(x)
  ...
  ObtenerReporteAdministrarUsuarioPorCodigoMatricula(CodigoMatricula:string){
    ...
    this._DevopsAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCodigoMatricula(this.CodigoMatriculaBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
  ...
  ObtenerReporteAdministrarUsuarioPorCentroCostos(CentroCostos:string){
    ...
    this._DevopsAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCentroCostos(this.CentroCostosBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
  ...
  GuardarCambios(data:any){
    ...
    this.EnvioAcceso.idTipoSimuladorWeb = 6;
    ...
    this._DevopsAdministrarUsuarios.GuardarCambiosAccesoSimulador(this.EnvioAcceso).subscribe({
      next: (x: any) => {
