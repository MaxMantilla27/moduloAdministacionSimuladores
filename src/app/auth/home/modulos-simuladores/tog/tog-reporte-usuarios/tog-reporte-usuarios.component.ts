...
import { TogAbrirModalDetalleExamenComponent } from './tog-abrir-modal-detalle-examen/tog-abrir-modal-detalle-examen.component';

@Component({
  selector: 'app-tog-reporte-usuarios',
  templateUrl: './tog-reporte-usuarios.component.html',
  styleUrls: ['./tog-reporte-usuarios.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class TogReporteUsuariosComponent implements OnInit {
  ...
  VerExamen(IdExamen:number){
    const dialogRef = this.dialog.open(TogAbrirModalDetalleExamenComponent, {
      width: '100%',
      height: '100%',
      maxHeight: '95%',
      maxWidth: '100%',
