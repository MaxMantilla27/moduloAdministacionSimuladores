...
import { TogModalAgregarSubcategoriaComponent } from './tog-modal-agregar-subcategoria/tog-modal-agregar-subcategoria.component';
import { TogModalAgregarCategoriaComponent } from './tog-modal-agregar-categoria/tog-modal-agregar-categoria.component';
...
import { filtro } from 'src/app/Models/Tog/TogTipoRespuesta';

@Component({
  selector: 'app-tog-configuracion-categorias',
  templateUrl: './tog-configuracion-categorias.component.html',
  styleUrls: ['./tog-configuracion-categorias.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class TogConfiguracionCategoriasComponent implements OnInit {
  displayedColumns: string[] = ['id', 'nombre', 'cantidad', 'proporcion'];

  constructor(
    public dialog: MatDialog,
    private _TipoDominio: TogCategoriasService,
  ...
  agregar() {
    this.isNew = false;
    const dialogRef = this.dialog.open(TogModalAgregarCategoriaComponent, {
      width: '60%',
