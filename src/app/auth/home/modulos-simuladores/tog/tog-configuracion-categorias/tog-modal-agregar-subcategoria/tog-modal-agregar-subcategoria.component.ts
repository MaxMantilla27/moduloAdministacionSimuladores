...
public jsonActualizar:TogActualizarTareaDTO = {
  ...
  ngOnInit(): void {
    ...
    if(this.data!=undefined)
    {
      ...
      this.formSubCategoria.get('IdCategoria')?.setValue(this.data[0].idSimuladorTogDominio)
  ...
  Agregar(){
    ...
    this.jsonEnvio.IdSimuladorTogDominio = this.formSubCategoria.get('IdCategoria')?.value
  ...
  Editar(){
    ...
    this.jsonActualizar.IdSimuladorTogDominio = this.formSubCategoria.get('IdCategoria')?.value
