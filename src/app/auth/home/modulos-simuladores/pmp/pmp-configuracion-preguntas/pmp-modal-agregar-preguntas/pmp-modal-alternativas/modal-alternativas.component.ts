...
export class ModalAlternativasComponent implements OnInit {
  ...
  public ActualizarAlternativaDTO: PmpPreguntaRespuestaEnvioDTO={
    Id:0,
    Respuesta:'',
    Correcto:false,
    Puntaje:0,
  ...
  public AgregarAlternativaDTO: PmpPreguntaRespuestaEnvioAgregarDTO = {
    Id:0,
    Respuesta:'',
    Correcto:false,
    Puntaje:0,
  ...
  EnviarRegistrosAlternativas(){
    ...
    if(this.data[3]== undefined ){
      this.AgregarAlternativaDTO.IdSimuladorPmpPregunta = 0
    }
    else{
      this.AgregarAlternativaDTO.IdSimuladorPmpPregunta = this.data[3]
    }
   

    this._alternativa.AgregarPmpPreguntaRespuesta(this.AgregarAlternativaDTO).subscribe({
      next: (x:any) => {
        console.log(x)
  ...
  ActualizarAlternativa(){
    ...
    this._alternativa.ActualizarPmpPreguntaRespuesta(this.ActualizarAlternativaDTO).subscribe({
      next: (x:any) => {
        console.log(x)
