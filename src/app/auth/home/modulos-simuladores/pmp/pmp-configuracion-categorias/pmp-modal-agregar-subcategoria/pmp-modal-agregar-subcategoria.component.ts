...
public jsonActualizar:pmpActualizarTareaDTO = {
  ...
  ngOnInit(): void {
    ...
    if(this.data!=undefined)
    {
      ...
      this.formCategoria.get('IdCategoria')?.setValue(this.data[0].idSimuladorPmpDominio)
  ...
  Editar(){
    ...
    this.jsonActualizar.IdSimuladorPmpDominio = this.formCategoria.get('IdCategoria')?.value
