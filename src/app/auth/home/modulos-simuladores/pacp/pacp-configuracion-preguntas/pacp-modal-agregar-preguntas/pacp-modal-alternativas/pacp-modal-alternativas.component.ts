...
import { PacpPreguntaRespuestaEnvioAgregarDTO, PacpPreguntaRespuestaEnvioDTO } from 'src/app/Models/Pacp/PacpPreguntaRespuestaDTO';
...
@Component({
  selector: 'app-pacp-modal-alternativas',
  templateUrl: './pacp-modal-alternativas.component.html',
  styleUrls: ['./pacp-modal-alternativas.component.scss']
})
export class PacpModalAlternativasComponent implements OnInit {

  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    public dialogRef: MatDialogRef<PacpModalAlternativasComponent>,
  ...
  public ActualizarAlternativaDTO: PacpPreguntaRespuestaEnvioDTO={
    Id:0,
    Respuesta:'',
    Correcto:false,
    Puntaje:0,
  ...
  public AgregarAlternativaDTO: PacpPreguntaRespuestaEnvioAgregarDTO = {
    Id:0,
    Respuesta:'',
    Correcto:false,
    Puntaje:0,
  ...
  EnviarRegistrosAlternativas(){
    ...
    if(this.data[3]== undefined ){
      this.AgregarAlternativaDTO.IdSimuladorPacpPregunta = 0
    }
    else{
      this.AgregarAlternativaDTO.IdSimuladorPacpPregunta = this.data[3]
    }
   

    this._alternativa.AgregarPacpPreguntaRespuesta(this.AgregarAlternativaDTO).subscribe({
      next: (x:any) => {
        console.log(x)
  ...
  ActualizarAlternativa(){
    ...
    this._alternativa.ActualizarPacpPreguntaRespuesta(this.ActualizarAlternativaDTO).subscribe({
      next: (x:any) => {
        console.log(x)
