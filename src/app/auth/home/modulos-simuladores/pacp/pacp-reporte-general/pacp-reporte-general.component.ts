...
export class PacpReporteGeneralComponent implements OnInit {
  constructor(
    private _PacpReporteGeneral: PacpReporteGeneralService,
  ...
  public EnvioCertificacion: PacpEnvioEstadoCertificacionAlumnoDTO={
  ...
  ngOnInit(): void {
    this.ObtenerReporteGeneralPacp();
    this.ObtenerComboCertificacionPacp();
  }
  ObtenerReporteGeneralPacp(){
    this._PacpReporteGeneral.ObtenerReporteGeneralPacp().subscribe({
      next: (x: any) => {
  ...
  ObtenerComboCertificacionPacp(){
    this._PacpReporteGeneral.ObtenerComboCertificacionPacp().subscribe({
      next: (x: any) => {
  ...
  GuardarCambios(data:any){
    ...
    this._PacpReporteGeneral.InsertarCertificacionPacp(this.EnvioCertificacion).subscribe({
      next: (x: any) => {
