...
import { filtradoAdministradorDTO } from 'src/app/Models/Pacp/PacpTipoRespuesta';
import { AlertaService } from 'src/app/shared/Services/Alerta/alerta.service';
import { PacpAdministrarUsuariosService } from 'src/app/shared/Services/Pacp/Pacp-Administrar-Usuarios/pacp-administrar-usuarios.service';

@Component({
  selector: 'app-pacp-administrar-usuarios',
  templateUrl: './pacp-administrar-usuarios.component.html',
  styleUrls: ['./pacp-administrar-usuarios.component.scss']
})
export class PacpAdministrarUsuariosComponent implements OnInit {

  constructor(
    public _PacpAdministrarUsuarios:PacpAdministrarUsuariosService,
  ...
  public EnvioAcceso: PacpAdministrarUsuariosAccesoDTO={
  ...
  ObtenerReporteAdministrarUsuarioResumen(){
    ...
    this._PacpAdministrarUsuarios.ObtenerReporteAdministrarUsuarioResumen().subscribe({
      next: (x: any) => {
        console.log(x)
  ...
  ObtenerReporteAdministrarUsuarioPorCodigoMatricula(CodigoMatricula:string){
    ...
    this._PacpAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCodigoMatricula(this.CodigoMatriculaBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
  ...
  ObtenerReporteAdministrarUsuarioPorCentroCostos(CentroCostos:string){
    ...
    this._PacpAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCentroCostos(this.CentroCostosBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
  ...
  GuardarCambios(data:any){
    ...
    this.EnvioAcceso.idTipoSimuladorWeb = 8;
    ...
    this._PacpAdministrarUsuarios.GuardarCambiosAccesoSimulador(this.EnvioAcceso).subscribe({
      next: (x: any) => {
