...
import { PacpAbrirModalDetalleExamenComponent } from './pacp-abrir-modal-detalle-examen/pacp-abrir-modal-detalle-examen.component';


@Component({
  selector: 'app-pacp-reporte-usuarios',
  templateUrl: './pacp-reporte-usuarios.component.html',
  styleUrls: ['./pacp-reporte-usuarios.component.scss']
})
export class PacpReporteUsuariosComponent implements OnInit {
  ...
  VerExamen(IdExamen:number){
    const dialogRef = this.dialog.open(PacpAbrirModalDetalleExamenComponent, {
      width: '100%',
      height: '100%',
      maxHeight: '95%',
      maxWidth: '100%',
