...
import { actualizarTipoRespuestaDTO } from 'src/app/Models/Labc/LabcTipoRespuesta';
import { LabcTipoRespuestaService } from 'src/app/shared/Services/Labc/Labc-Tipo-Respuesta/labc-tipo-respuesta.service';

@Component({
  selector: 'app-labc-configuracion-tipo-preguntas',
  templateUrl: './labc-configuracion-tipo-preguntas.component.html',
  styleUrls: ['./labc-configuracion-tipo-preguntas.component.scss']
})
export class LabcConfiguracionTipoPreguntasComponent implements OnInit {

  http: any;

  constructor(private _TipoRespuesta: LabcTipoRespuestaService) {}
