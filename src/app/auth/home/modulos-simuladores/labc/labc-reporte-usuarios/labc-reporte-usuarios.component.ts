...
import { LabcAbrirModalDetalleExamenComponent } from './labc-abrir-modal-detalle-examen/labc-abrir-modal-detalle-examen.component';

@Component({
  selector: 'app-labc-reporte-usuarios',
  templateUrl: './labc-reporte-usuarios.component.html',
  styleUrls: ['./labc-reporte-usuarios.component.scss']
})
export class LabcReporteUsuariosComponent implements OnInit {
  ...
  VerExamen(IdExamen:number){
    const dialogRef = this.dialog.open(LabcAbrirModalDetalleExamenComponent, {
      width: '100%',
      height: '100%',
      maxHeight: '95%',
      maxWidth: '100%',
