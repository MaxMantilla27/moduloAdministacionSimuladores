...
import { LabcPreguntaActualizarDTO, LabcPreguntaDTO } from 'src/app/Models/Labc/LabcPreguntaDTO';
import { AlertaService } from 'src/app/shared/Services/Alerta/alerta.service';
import { LabcCategoriasService } from 'src/app/shared/Services/Labc/Labc-Categorias/labc-categorias.service';

@Component({
  selector: 'app-labc-modal-agregar-categoria',
  templateUrl: './labc-modal-agregar-categoria.component.html',
  styleUrls: ['./labc-modal-agregar-categoria.component.scss']
})
export class LabcModalAgregarCategoriaComponent implements OnInit {
  constructor(
    public dialogRef: MatDialogRef<LabcModalAgregarCategoriaComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private alertaService: AlertaService,
    private formBuilder: FormBuilder,
    private _Dominio: LabcCategoriasService
  ) { }
  ...
  public jsonEnvio:LabcPreguntaDTO = {
    Nombre: 'Prueba',
  ...
  public jsonActualizar:LabcPreguntaActualizarDTO = {
    Id: 0,
    Nombre: 'Prueba',
    CantidadPreguntasPorExamen: 5,
    CantidadTotal: 5,
