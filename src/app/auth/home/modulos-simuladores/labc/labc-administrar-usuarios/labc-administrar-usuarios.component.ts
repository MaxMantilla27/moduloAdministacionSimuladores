...
import { filtradoAdministradorDTO } from 'src/app/Models/Labc/LabcTipoRespuesta';
import { AlertaService } from 'src/app/shared/Services/Alerta/alerta.service';
import { LabcAdministrarUsuariosService } from 'src/app/shared/Services/Labc/Labc-Administrar-Usuarios/labc-administrar-usuarios.service';

@Component({
  selector: 'app-labc-administrar-usuarios',
  templateUrl: './labc-administrar-usuarios.component.html',
  styleUrls: ['./labc-administrar-usuarios.component.scss']
})
export class LabcAdministrarUsuariosComponent implements OnInit {

  constructor(
    public _LabcAdministrarUsuarios:LabcAdministrarUsuariosService,
  ...
  public EnvioAcceso: LabcAdministrarUsuariosAccesoDTO={
  ...
  ObtenerReporteAdministrarUsuarioResumen(){
    ...
    this._LabcAdministrarUsuarios.ObtenerReporteAdministrarUsuarioResumen().subscribe({
      next: (x: any) => {
        console.log(x)
  ...
  ObtenerReporteAdministrarUsuarioPorCodigoMatricula(CodigoMatricula:string){
    ...
    this._LabcAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCodigoMatricula(this.CodigoMatriculaBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
  ...
  ObtenerReporteAdministrarUsuarioPorCentroCostos(CentroCostos:string){
    ...
    this._LabcAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCentroCostos(this.CentroCostosBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
  ...
  GuardarCambios(data:any){
    ...
    this.EnvioAcceso.idTipoSimuladorWeb = 10;
    ...
    this._LabcAdministrarUsuarios.GuardarCambiosAccesoSimulador(this.EnvioAcceso).subscribe({
      next: (x: any) => {
