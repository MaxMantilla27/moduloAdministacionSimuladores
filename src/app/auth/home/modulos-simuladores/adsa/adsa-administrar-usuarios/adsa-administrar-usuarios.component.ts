...
import { filtradoAdministradorDTO } from 'src/app/Models/Adsa/AdsaTipoRespuesta';
import { AlertaService } from 'src/app/shared/Services/Alerta/alerta.service';
import { AdsaAdministrarUsuariosService } from 'src/app/shared/Services/Adsa/Adsa-Administrar-Usuarios/adsa-administrar-usuarios.service';
@Component({
  selector: 'app-adsa-administrar-usuarios',
  templateUrl: './adsa-administrar-usuarios.component.html',
  styleUrls: ['./adsa-administrar-usuarios.component.scss']
})
export class AdsaAdministrarUsuariosComponent implements OnInit {

  constructor(
    public _AdsaAdministrarUsuarios:AdsaAdministrarUsuariosService,
  ...
  public EnvioAcceso: AdsaAdministrarUsuariosAccesoDTO={
  ...
  ObtenerReporteAdministrarUsuarioResumen(){
    ...
    this._AdsaAdministrarUsuarios.ObtenerReporteAdministrarUsuarioResumen().subscribe({
      next: (x: any) => {
        console.log(x)
  ...
  ObtenerReporteAdministrarUsuarioPorCodigoMatricula(CodigoMatricula:string){
    ...
    this._AdsaAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCodigoMatricula(this.CodigoMatriculaBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
...
if(e.fechaCaducidadSimulador!=undefined && e.fechaCaducidadSimulador!=null){
  ...
  ObtenerReporteAdministrarUsuarioPorCentroCostos(CentroCostos:string){
    ...
    this._AdsaAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCentroCostos(this.CentroCostosBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
...
if(e.fechaCaducidadSimulador!=undefined && e.fechaCaducidadSimulador!=null){
  ...
  GuardarCambios(data:any){
    ...
    this._AdsaAdministrarUsuarios.GuardarCambiosAccesoSimulador(this.EnvioAcceso).subscribe({
      next: (x: any) => {
