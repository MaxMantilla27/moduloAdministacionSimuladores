...
@Component({
  selector: 'app-adsa-modal-alternativas',
  templateUrl: './adsa-modal-alternativas.component.html',
  styleUrls: ['./adsa-modal-alternativas.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class AdsaModalAlternativasComponent implements OnInit {

  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    public dialogRef: MatDialogRef<AdsaModalAlternativasComponent>,
  ...
  public ActualizarAlternativaDTO: AdsaPreguntaRespuestaEnvioDTO={
    Id:0,
    Respuesta:'',
    Correcto:false,
    Puntaje:0,
  ...
  public AgregarAlternativaDTO: AdsaPreguntaRespuestaEnvioAgregarDTO = {
    Id:0,
    Respuesta:'',
    Correcto:false,
    Puntaje:0,
  ...
  EnviarRegistrosAlternativas(){
    ...
    if(this.data[3]== undefined ){
      this.AgregarAlternativaDTO.IdSimuladorAdsaPregunta = 0
    }
    else{
      this.AgregarAlternativaDTO.IdSimuladorAdsaPregunta = this.data[3]
    }
   

    this._alternativa.AgregarAdsaPreguntaRespuesta(this.AgregarAlternativaDTO).subscribe({
      next: (x:any) => {
        console.log(x)
  ...
  ActualizarAlternativa(){
    ...
    this._alternativa.ActualizarAdsaPreguntaRespuesta(this.ActualizarAlternativaDTO).subscribe({
      next: (x:any) => {
        console.log(x)
