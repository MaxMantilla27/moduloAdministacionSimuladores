...
@Component({
  selector: 'app-adsa-modal-agregar-categoria',
  templateUrl: './adsa-modal-agregar-categoria.component.html',
  styleUrls: ['./adsa-modal-agregar-categoria.component.scss'],
...
export class adsaModalAgregarCategoriaComponent implements OnInit {
  ...
  public jsonEnvio:adsaPreguntaDTO = {
    Nombre: 'Prueba',
  ...
  public jsonActualizar:adsaPreguntaActualizarDTO = {
    Id: 0,
    Nombre: 'Prueba',
    CantidadPreguntasPorExamen: 5,
    CantidadTotal: 5,
