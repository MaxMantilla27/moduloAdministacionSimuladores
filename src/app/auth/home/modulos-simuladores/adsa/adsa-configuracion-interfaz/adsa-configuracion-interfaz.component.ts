...
import { actualizarParametrosNivel, actualizarTipoRespuestaDTO,actualizarInterfaz } from 'src/app/Models/Adsa/AdsaTipoRespuesta';
...
@Component({
  selector: 'app-adsa-configuracion-interfaz',
  templateUrl: './adsa-configuracion-interfaz.component.html',
  styleUrls: ['./adsa-configuracion-interfaz.component.scss']
})
export class AdsaConfiguracionInterfazComponent implements OnInit {

  constructor(
    private _TipoRespuesta: AdsaTipoRespuestaService,
...
ActualizarInterfaz(){
  ...
  this._AdsaConfiguracionSimulador.AdsaActualizarConfiguracionSimulador(this.actualizar).subscribe({
    next: (x: any) => {
