...
import { actualizarParametrosNivel, actualizarInterfaz } from 'src/app/Models/Cmrp/CmrpTipoRespuesta';
...
@Component({
  selector: 'app-cmrp-configuracion-interfaz',
  templateUrl: './cmrp-configuracion-interfaz.component.html',
  styleUrls: ['./cmrp-configuracion-interfaz.component.scss']
})
export class CmrpConfiguracionInterfazComponent implements OnInit {
...
ActualizarInterfaz(){
  ...
  this._CmrpConfiguracionSimulador.CmrpActualizarConfiguracionSimulador(this.actualizar).subscribe({
    next: (x) => {
    },
    error:(e)=>{
