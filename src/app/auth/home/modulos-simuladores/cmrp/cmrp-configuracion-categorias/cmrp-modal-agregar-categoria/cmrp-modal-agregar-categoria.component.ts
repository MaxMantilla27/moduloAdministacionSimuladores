...
@Component({
  selector: 'app-cmrp-modal-agregar-categoria',
  templateUrl: './cmrp-modal-agregar-categoria.component.html',
  styleUrls: ['./cmrp-modal-agregar-categoria.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class CmrpModalAgregarCategoriaComponent implements OnInit {

  constructor(
    public dialogRef: MatDialogRef<CmrpModalAgregarCategoriaComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private alertaService: AlertaService,
    private formBuilder: FormBuilder,
    private _Dominio: CmrpCategoriasService
  ) { }
  ...
  public fileErrorMsg=''
  public jsonEnvio:CmrpPreguntaDTO = {
    Nombre: '',
  ...
  public jsonActualizar:CmrpPreguntaActualizarDTO = {
    Id: 0,
    Nombre: '',
    CantidadPreguntasPorExamen: 0,
    CantidadTotal: 0,
