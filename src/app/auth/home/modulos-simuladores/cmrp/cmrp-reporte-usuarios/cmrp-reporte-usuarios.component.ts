...
import { CmrpAbrirModalDetalleExamenComponent } from './cmrp-abrir-modal-detalle-examen/cmrp-abrir-modal-detalle-examen.component';

@Component({
  selector: 'app-cmrp-reporte-usuarios',
  templateUrl: './cmrp-reporte-usuarios.component.html',
  styleUrls: ['./cmrp-reporte-usuarios.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class CmrpReporteUsuariosComponent implements OnInit {
  ...
  VerExamen(IdExamen:number){
    const dialogRef = this.dialog.open(CmrpAbrirModalDetalleExamenComponent, {
      width: '100%',
      height: '100%',
      maxHeight: '95%',
      maxWidth: '100%',
