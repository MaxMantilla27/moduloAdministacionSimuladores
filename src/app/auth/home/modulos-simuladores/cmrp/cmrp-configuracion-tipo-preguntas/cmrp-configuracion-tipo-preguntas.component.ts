...
@Component({
  selector: 'app-cmrp-configuracion-tipo-preguntas',
  templateUrl: './cmrp-configuracion-tipo-preguntas.component.html',
  styleUrls: ['./cmrp-configuracion-tipo-preguntas.component.scss'],
})
