...
import { filtradoReporteGeneralDTO } from 'src/app/Models/Cmrp/CmrpTipoRespuesta';
import { AlertaService } from 'src/app/shared/Services/Alerta/alerta.service';
import { CmrpReporteGeneralService } from 'src/app/shared/Services/Cmrp/Cmrp-Reporte-General/cmrp-reporte-general.service';

@Component({
  selector: 'app-cmrp-reporte-general',
  templateUrl: './cmrp-reporte-general.component.html',
  styleUrls: ['./cmrp-reporte-general.component.scss']
})
export class CmrpReporteGeneralComponent implements OnInit {

  constructor(
    private _CmrpReporteGeneral: CmrpReporteGeneralService,
  ...
  public EnvioCertificacion: CmrpEnvioEstadoCertificacionAlumnoDTO={
  ...
  ngOnInit(): void {
    this.ObtenerReporteGeneralCmrp();
    this.ObtenerComboCertificacionCmrp();
  }
  ObtenerReporteGeneralCmrp(){
    this._CmrpReporteGeneral.ObtenerReporteGeneralCmrp().subscribe({
      next: (x: any) => {
  ...
  ObtenerComboCertificacionCmrp(){
    this._CmrpReporteGeneral.ObtenerComboCertificacionCmrp().subscribe({
      next: (x: any) => {
  ...
  GuardarCambios(data:any){
    ...
    this._CmrpReporteGeneral.InsertarCertificacionCmrp(this.EnvioCertificacion).subscribe({
      next: (x: any) => {
