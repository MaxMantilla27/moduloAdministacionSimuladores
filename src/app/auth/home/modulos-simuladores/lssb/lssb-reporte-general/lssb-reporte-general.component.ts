...
import { filtradoReporteGeneralDTO } from 'src/app/Models/Lssb/LssbTipoRespuesta';
import { AlertaService } from 'src/app/shared/Services/Alerta/alerta.service';
import { LssbReporteGeneralService } from 'src/app/shared/Services/Lssb/Lssb-Reporte-General/lssb-reporte-general.service';

@Component({
  selector: 'app-lssb-reporte-general',
  templateUrl: './lssb-reporte-general.component.html',
  styleUrls: ['./lssb-reporte-general.component.scss']
})
export class LssbReporteGeneralComponent implements OnInit {

  constructor(
    private _LssbReporteGeneral: LssbReporteGeneralService,
  ...
  public EnvioCertificacion: LssbEnvioEstadoCertificacionAlumnoDTO={
  ...
  ngOnInit(): void {
    this.ObtenerReporteGeneralLssb();
    this.ObtenerComboCertificacionLssb();
  }
  ObtenerReporteGeneralLssb(){
    this._LssbReporteGeneral.ObtenerReporteGeneralLssb().subscribe({
      next: (x: any) => {
  ...
  ObtenerComboCertificacionLssb(){
    this._LssbReporteGeneral.ObtenerComboCertificacionLssb().subscribe({
      next: (x: any) => {
  ...
  GuardarCambios(data:any){
    ...
    this._LssbReporteGeneral.InsertarCertificacionLssb(this.EnvioCertificacion).subscribe({
      next: (x: any) => {
