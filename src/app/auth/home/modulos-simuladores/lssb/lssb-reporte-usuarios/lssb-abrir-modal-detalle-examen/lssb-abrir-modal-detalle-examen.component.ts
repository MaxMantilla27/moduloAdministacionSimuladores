...
@Component({
  selector: 'app-lssb-abrir-modal-detalle-examen',
  templateUrl: './lssb-abrir-modal-detalle-examen.component.html',
  styleUrls: ['./lssb-abrir-modal-detalle-examen.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class LssbAbrirModalDetalleExamenComponent implements OnInit {

  constructor(
    public dialogRef: MatDialogRef<LssbAbrirModalDetalleExamenComponent>,
