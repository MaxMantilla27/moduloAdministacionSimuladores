...
public jsonActualizar:LssbActualizarTareaDTO = {
  ...
  ngOnInit(): void {
    ...
    if(this.data!=undefined)
    {
      ...
      this.formCategoria.get('IdCategoria')?.setValue(this.data[0].idSimuladorLssbDominio)
  ...
  Agregar(){
    ...
    this.jsonEnvio.IdSimuladorLssbDominio = this.formCategoria.get('IdCategoria')?.value
  ...
  Editar(){
    ...
    this.jsonActualizar.IdSimuladorLssbDominio = this.formCategoria.get('IdCategoria')?.value
