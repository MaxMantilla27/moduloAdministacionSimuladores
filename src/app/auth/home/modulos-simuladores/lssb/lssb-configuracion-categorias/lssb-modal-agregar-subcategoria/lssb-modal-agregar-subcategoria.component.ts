...
@Component({
  selector: 'app-lssb-modal-agregar-subcategoria',
  templateUrl: './lssb-modal-agregar-subcategoria.component.html',
  styleUrls: ['./lssb-modal-agregar-subcategoria.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class LssbModalAgregarSubcategoriaComponent implements OnInit {

  constructor(
    public dialogRef: MatDialogRef<LssbModalAgregarSubcategoriaComponent>,
...
public jsonEnvio:LssbAgregarTareaDTO = {
...
public jsonActualizar:LssbActualizarTareaDTO = {
  Id:0,
  IdSimuladorLssbDominio: 0,
  Nombre: '',
  CantidadPreguntasPorExamen: 0,
  ...
  ngOnInit(): void {
    ...
    if(this.data!=undefined)
    {
      ...
      this.formSubCategoria.get('IdCategoria')?.setValue(this.data[0].idSimuladorLssbDominio)
  ...
  Agregar(){
    ...
    this.jsonEnvio.IdSimuladorLssbDominio = this.formSubCategoria.get('IdCategoria')?.value
  ...
  Editar(){
    ...
    this.jsonActualizar.IdSimuladorLssbDominio = this.formSubCategoria.get('IdCategoria')?.value
