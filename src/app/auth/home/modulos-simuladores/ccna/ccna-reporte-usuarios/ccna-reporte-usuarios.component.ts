...
import { CcnaAbrirModalDetalleExamenComponent } from './ccna-abrir-modal-detalle-examen/ccna-abrir-modal-detalle-examen.component';


@Component({
  selector: 'app-ccna-reporte-usuarios',
  templateUrl: './ccna-reporte-usuarios.component.html',
  styleUrls: ['./ccna-reporte-usuarios.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class CcnaReporteUsuariosComponent implements OnInit {
  ...
  VerExamen(IdExamen:number){
    const dialogRef = this.dialog.open(CcnaAbrirModalDetalleExamenComponent, {
      width: '100%',
      height: '100%',
      maxHeight: '95%',
      maxWidth: '100%',
