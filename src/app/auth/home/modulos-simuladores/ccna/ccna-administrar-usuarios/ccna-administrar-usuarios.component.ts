...
import { filtradoAdministradorDTO } from 'src/app/Models/Ccna/CcnaTipoRespuesta';
import { AlertaService } from 'src/app/shared/Services/Alerta/alerta.service';
import { CcnaAdministrarUsuariosService } from 'src/app/shared/Services/Ccna/Ccna-Administrar-Usuarios/ccna-administrar-usuarios.service';
@Component({
  selector: 'app-ccna-administrar-usuarios',
  templateUrl: './ccna-administrar-usuarios.component.html',
  styleUrls: ['./ccna-administrar-usuarios.component.scss']
})
export class CcnaAdministrarUsuariosComponent implements OnInit {

  constructor(
    public _CcnaAdministrarUsuarios:CcnaAdministrarUsuariosService,
  ...
  public EnvioAcceso: CcnaAdministrarUsuariosAccesoDTO={
  ...
  ngOnInit(): void {
    this.ObtenerReporteAdministrarUsuarioResumenCcna();
  }
  ObtenerReporteAdministrarUsuarioResumenCcna(){
    ...
    this._CcnaAdministrarUsuarios.ObtenerReporteAdministrarUsuarioResumenCcna().subscribe({
      next: (x: any) => {
        console.log(x)
  ...
  ObtenerReporteAdministrarUsuarioPorCodigoMatriculaCcna(CodigoMatricula:string){
    this.listOfDisplayData=undefined;
    this.DisabledDescargaExcel=true;
    ...
    this._CcnaAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCodigoMatriculaCcna(this.CodigoMatriculaBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
...
if(e.fechaCaducidadSimulador!=undefined && e.fechaCaducidadSimulador!=null){
  ...
  ObtenerReporteAdministrarUsuarioPorCentroCostosCcna(CentroCostos:string){
    this.listOfDisplayData=undefined;
    this.DisabledDescargaExcel=true;
    var datePipe = new DatePipe('en-US');
    this.editarReporte=false;
    ...
    this._CcnaAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCentroCostosCcna(this.CentroCostosBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
...
if(e.fechaCaducidadSimulador!=undefined && e.fechaCaducidadSimulador!=null){
  ...
  GuardarCambios(data:any){
    ...
    this.EnvioAcceso.idTipoSimuladorWeb = 11;
    ...
    this._CcnaAdministrarUsuarios.GuardarCambiosAccesoSimuladorCcna(this.EnvioAcceso).subscribe({
      next: (x: any) => {
