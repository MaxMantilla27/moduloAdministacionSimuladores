...
import { filtro } from 'src/app/Models/Ccna/CcnaTipoRespuesta';
...
import { CcnaModalAgregarCategoriaComponent } from './ccna-modal-agregar-categoria/ccna-modal-agregar-categoria.component';

@Component({
  selector: 'app-ccna-configuracion-categorias',
  templateUrl: './ccna-configuracion-categorias.component.html',
  styleUrls: ['./ccna-configuracion-categorias.component.scss']
})
export class CcnaConfiguracionCategoriasComponent implements OnInit {

  displayedColumns: string[] = ['id', 'nombre', 'cantidad', 'proporcion'];

  constructor(
    public dialog: MatDialog,
    private _TipoDominio: CcnaCategoriasService,
    private _tarea: CcnaTareaService,
  ...
  openDialogSub() {
    const dialogRef = this.dialog.open(CcnaModalAgregarCategoriaComponent, {
      width: '1000px',
      maxHeight: '90vh',
