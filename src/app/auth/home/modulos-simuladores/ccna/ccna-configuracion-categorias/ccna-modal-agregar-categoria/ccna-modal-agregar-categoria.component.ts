...
import { ccnaPreguntaActualizarDTO, ccnaPreguntaDTO } from 'src/app/Models/Ccna/CcnaPreguntaDTO';
...
@Component({
  selector: 'app-Ccna-modal-agregar-categoria',
  templateUrl: './Ccna-modal-agregar-categoria.component.html',
  styleUrls: ['./Ccna-modal-agregar-categoria.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class CcnaModalAgregarCategoriaComponent implements OnInit {

  constructor(
    public dialogRef: MatDialogRef<CcnaModalAgregarCategoriaComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private alertaService: AlertaService,
    private formBuilder: FormBuilder,
    private _Dominio: CcnaCategoriasService
  ) { }
  ...
  public jsonEnvio: ccnaPreguntaDTO = {
    Nombre: 'Prueba',
  ...
  public jsonActualizar:ccnaPreguntaActualizarDTO = {
    Id: 0,
    Nombre: 'Prueba',
    CantidadPreguntasPorExamen: 5,
    CantidadTotal: 5,
