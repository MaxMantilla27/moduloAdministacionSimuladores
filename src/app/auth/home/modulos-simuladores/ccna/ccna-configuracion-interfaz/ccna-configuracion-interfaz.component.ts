...
import { actualizarParametrosNivel, actualizarTipoRespuestaDTO,actualizarInterfaz } from 'src/app/Models/Ccna/CcnaTipoRespuesta';
...
@Component({
  selector: 'app-ccna-configuracion-interfaz',
  templateUrl: './ccna-configuracion-interfaz.component.html',
  styleUrls: ['./ccna-configuracion-interfaz.component.scss']
})
export class CcnaConfiguracionInterfazComponent implements OnInit {

  constructor(
    private _TipoRespuesta: CcnaTipoRespuestaService,
...
ActualizarInterfaz(){
  ...
  this._CcnaConfiguracionSimulador.CcnaActualizarConfiguracionSimulador(this.actualizar).subscribe({
    next: (x) => {
    },
    error:(e)=>{
