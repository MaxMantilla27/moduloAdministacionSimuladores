...
import { AwsPreguntaRespuestaEnvioAgregarDTO, AwsPreguntaRespuestaEnvioDTO } from 'src/app/Models/Aws/AwsPreguntaRespuestaDTO';
import { AwsPreguntaRespuestaService } from 'src/app/shared/Services/Aws/Aws-PreguntaRespuesta/aws-pregunta-respuesta.service';

@Component({
  selector: 'app-aws-modal-alternativas',
  templateUrl: './aws-modal-alternativas.component.html',
  styleUrls: ['./aws-modal-alternativas.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class AwsModalAlternativasComponent implements OnInit {

  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    public dialogRef: MatDialogRef<AwsModalAlternativasComponent>,
    private _alternativa: AwsPreguntaRespuestaService,
  ...
  public ActualizarAlternativaDTO: AwsPreguntaRespuestaEnvioDTO={
    Id:0,
    Respuesta:'',
    Correcto:false,
    Puntaje:0,
  ...
  public AgregarAlternativaDTO: AwsPreguntaRespuestaEnvioAgregarDTO = {
    Id:0,
    Respuesta:'',
    Correcto:false,
    Puntaje:0,
  ...
  EnviarRegistrosAlternativas(){
    ...
    this._alternativa.AgregarAwsPreguntaRespuesta(this.AgregarAlternativaDTO).subscribe({
      next: (x:any) => {
        console.log(x)
  ...
  ActualizarAlternativa(){
    ...
    this._alternativa.ActualizarAwsPreguntaRespuesta(this.ActualizarAlternativaDTO).subscribe({
      next: (x:any) => {
        console.log(x)
