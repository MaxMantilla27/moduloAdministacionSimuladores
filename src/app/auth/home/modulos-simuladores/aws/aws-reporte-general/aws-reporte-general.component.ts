...
import { filtradoReporteGeneralDTO } from 'src/app/Models/Aws/AwsTipoRespuesta';
import { AlertaService } from 'src/app/shared/Services/Alerta/alerta.service';
import { AwsReporteGeneralService } from 'src/app/shared/Services/Aws/Aws-Reporte-General/aws-reporte-general.service';

@Component({
  selector: 'app-aws-reporte-general',
  templateUrl: './aws-reporte-general.component.html',
  styleUrls: ['./aws-reporte-general.component.scss']
})
export class AwsReporteGeneralComponent implements OnInit {

  constructor(
    private _AwsReporteGeneral: AwsReporteGeneralService,
  ...
  public EnvioCertificacion: AwsEnvioEstadoCertificacionAlumnoDTO={
  ...
  ngOnInit(): void {
    this.ObtenerReporteGeneralAws();
    this.ObtenerComboCertificacionAws();
  }
  ObtenerReporteGeneralAws(){
    this._AwsReporteGeneral.ObtenerReporteGeneralAws().subscribe({
      next: (x: any) => {
  ...
  ObtenerComboCertificacionAws(){
    this._AwsReporteGeneral.ObtenerComboCertificacionAws().subscribe({
      next: (x: any) => {
  ...
  GuardarCambios(data:any){
    ...
    this._AwsReporteGeneral.InsertarCertificacionAws(this.EnvioCertificacion).subscribe({
      next: (x: any) => {
