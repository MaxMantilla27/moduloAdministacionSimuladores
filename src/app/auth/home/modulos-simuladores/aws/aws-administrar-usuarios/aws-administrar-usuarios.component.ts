...
import { filtradoAdministradorDTO } from 'src/app/Models/Aws/AwsTipoRespuesta';
import { AlertaService } from 'src/app/shared/Services/Alerta/alerta.service';
import { AwsAdministrarUsuariosService } from 'src/app/shared/Services/Aws/Aws-Administrar-Usuarios/aws-administrar-usuarios.service';
@Component({
  selector: 'app-aws-administrar-usuarios',
  templateUrl: './aws-administrar-usuarios.component.html',
  styleUrls: ['./aws-administrar-usuarios.component.scss']
})
export class AwsAdministrarUsuariosComponent implements OnInit {

  constructor(
    public _AwsAdministrarUsuarios:AwsAdministrarUsuariosService,
  ...
  public EnvioAcceso: AwsAdministrarUsuariosAccesoDTO={
  ...
  ngOnInit(): void {
    this.ObtenerReporteAdministrarUsuarioResumenAws();
  }
  ObtenerReporteAdministrarUsuarioResumenAws(){
    ...
    this._AwsAdministrarUsuarios.ObtenerReporteAdministrarUsuarioResumenAws().subscribe({
      next: (x: any) => {
        console.log(x)
  ...
  ObtenerReporteAdministrarUsuarioPorCodigoMatriculaAws(CodigoMatricula:string){
    this.listOfDisplayData=undefined;
    this.DisabledDescargaExcel=true;
    ...
    this._AwsAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCodigoMatriculaAws(this.CodigoMatriculaBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
...
if(e.fechaCaducidadSimulador!=undefined && e.fechaCaducidadSimulador!=null){
  ...
  ObtenerReporteAdministrarUsuarioPorCentroCostosAws(CentroCostos:string){
    this.listOfDisplayData=undefined;
    this.DisabledDescargaExcel=true;
    var datePipe = new DatePipe('en-US');
    this.editarReporte=false;
    ...
    this._AwsAdministrarUsuarios.ObtenerReporteAdministrarUsuarioPorCentroCostosAws(this.CentroCostosBuscar).subscribe({
      next: (x: any) => {
        console.log(x)
...
if(e.fechaCaducidadSimulador!=undefined && e.fechaCaducidadSimulador!=null){
  ...
  GuardarCambios(data:any){
    ...
    this.EnvioAcceso.idTipoSimuladorWeb = 4;
    ...
    this._AwsAdministrarUsuarios.GuardarCambiosAccesoSimuladorAws(this.EnvioAcceso).subscribe({
      next: (x: any) => {
