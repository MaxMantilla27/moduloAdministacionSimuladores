...
@Component({
  ...
  templateUrl: './ciss-configuracion-interfaz.component.html',
  styleUrls: ['./ciss-configuracion-interfaz.component.scss']
})
export class CissConfiguracionInterfazComponent implements OnInit {
