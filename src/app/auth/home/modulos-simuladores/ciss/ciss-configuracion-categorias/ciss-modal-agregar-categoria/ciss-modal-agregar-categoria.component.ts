...
@Component({
  selector: 'app-ciss-modal-agregar-categoria',
  templateUrl: './ciss-modal-agregar-categoria.component.html',
  styleUrls: ['./ciss-modal-agregar-categoria.component.scss']
})
export class CissModalAgregarCategoriaComponent implements OnInit {

  constructor(
    public dialogRef: MatDialogRef<CissModalAgregarCategoriaComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private alertaService: AlertaService,
    private formBuilder: FormBuilder,
    private _Dominio: CissCategoriasService
  ) { }
  ...
  public jsonEnvio:CissPreguntaDTO = {
    Nombre: 'Prueba',
  ...
  public jsonActualizar:CissPreguntaActualizarDTO = {
    Id: 0,
    Nombre: 'Prueba',
    CantidadPreguntasPorExamen: 5,
    CantidadTotal: 5,
