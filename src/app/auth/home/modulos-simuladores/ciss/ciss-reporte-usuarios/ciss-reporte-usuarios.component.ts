...
import { CissAbrirModalDetalleExamenComponent } from './ciss-abrir-modal-detalle-examen/ciss-abrir-modal-detalle-examen.component';

@Component({
  selector: 'app-ciss-reporte-usuarios',
  templateUrl: './ciss-reporte-usuarios.component.html',
  styleUrls: ['./ciss-reporte-usuarios.component.scss']
})
export class CissReporteUsuariosComponent implements OnInit {
  ...
  VerExamen(IdExamen:number){
    const dialogRef = this.dialog.open(CissAbrirModalDetalleExamenComponent, {
      width: '100%',
      height: '100%',
      maxHeight: '95%',
      maxWidth: '100%',
