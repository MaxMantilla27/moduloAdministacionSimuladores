...
export class LabcCategoriasService {

  public urlBase=environment.url_api+'LabcTipoDominio';
  ...
  public AgregarCategoria(listaPregunta: LabcPreguntaDTO):Observable<any>{
  ...
  public ActualizarCategoria(listaPregunta: LabcPreguntaActualizarDTO):Observable<any>{
    const formData: FormData = new FormData();
