...
import { adsaActualizarTareaDTO, adsaAgregarTareaDTO } from 'src/app/Models/Adsa/AdsaTareaDTO';
import { environment } from 'src/environments/environment';

@Injectable({
  providedIn: 'root'
})
export class AdsaTareaService {

  public urlBase=environment.url_api+'AdsaTarea';
  ...
  public AgregarSubCategoria(listaPregunta: adsaAgregarTareaDTO):Observable<any>{
  ...
  public ActualizarSubCategoria(listaPregunta: adsaActualizarTareaDTO):Observable<any>{
    const formData: FormData = new FormData();
