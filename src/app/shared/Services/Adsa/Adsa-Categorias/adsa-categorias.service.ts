...
import { adsaPreguntaActualizarDTO, adsaPreguntaDTO } from 'src/app/Models/Adsa/AdsaPreguntaDTO';
import { environment } from 'src/environments/environment';

@Injectable({
  providedIn: 'root'
})
export class AdsaCategoriasService {

  public urlBase=environment.url_api+'AdsaTipoDominio';
  ...
  public AgregarCategoria(listaPregunta: adsaPreguntaDTO):Observable<any>{
  ...
  public ActualizarCategoria(listaPregunta: adsaPreguntaActualizarDTO):Observable<any>{
    const formData: FormData = new FormData();
