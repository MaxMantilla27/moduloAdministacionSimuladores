...
export class PbiCategoriasService {

  public urlBase=environment.url_api+'PbiTipoDominio';
  ...
  public AgregarCategoria(listaPregunta: pbiPreguntaDTO):Observable<any>{
  ...
  public ActualizarCategoria(listaPregunta: pbiPreguntaActualizarDTO):Observable<any>{
    const formData: FormData = new FormData();
