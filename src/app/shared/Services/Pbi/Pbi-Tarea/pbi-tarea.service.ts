...
import { pbiActualizarTareaDTO, pbiAgregarTareaDTO } from 'src/app/Models/Pbi/PbiTareaDTO';
import { environment } from 'src/environments/environment';

@Injectable({
  providedIn: 'root'
})
export class PbiTareaService {

  public urlBase=environment.url_api+'PbiTarea';
  ...
  public AgregarSubCategoria(listaPregunta: pbiAgregarTareaDTO):Observable<any>{
  ...
  public ActualizarSubCategoria(listaPregunta: pbiActualizarTareaDTO):Observable<any>{
    const formData: FormData = new FormData();
