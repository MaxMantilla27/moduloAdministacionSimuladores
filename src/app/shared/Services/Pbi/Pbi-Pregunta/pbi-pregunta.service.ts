...
import { PbiEnvioFilePreguntaActualizarDTO, PbiEnvioFilePreguntaDTO, pbiPreguntaDTO } from 'src/app/Models/Pbi/PbiPreguntaDTO';
...
export class PbiPreguntaService {
  ...
  public ObtenerPbiPregunta(IdPregunta: number):Observable<any>{
    return this.http.post<any>(this.urlBase+'/ObtenerPbiPregunta?IdPregunta='+IdPregunta,'');
  }
  ...
  public AgregarPregunta(listaPregunta: PbiEnvioFilePreguntaDTO):Observable<any>{
   ...
   return this.http.post<any>(this.urlBase+'/RegistrarPbiPregunta',formData);
  }
  ...
  public ActualizarPregunta(listaPregunta: PbiEnvioFilePreguntaActualizarDTO):Observable<any>{
    const formData: FormData = new FormData();
    console.log(listaPregunta);
    formData.append('Id', listaPregunta.Id.toString());
    formData.append('IdSimuladorPbiDominio', listaPregunta.IdSimuladorPbiDominio.toString());
    ...
    formData.append('ImgRetroalimentacionArchivo', listaPregunta.ImgRetroalimentacionArchivo);
   console.log(formData)
   return this.http.post<any>(this.urlBase+'/ActualizarPbiPregunta',formData);
  }
}
