...
export class PacpCategoriasService {

  public urlBase=environment.url_api+'PacpTipoDominio';
  ...
  public AgregarCategoria(listaPregunta: PacpPreguntaDTO):Observable<any>{
  ...
  public ActualizarCategoria(listaPregunta: PacpPreguntaActualizarDTO):Observable<any>{
    const formData: FormData = new FormData();
