...
export class CcnaCategoriasService {

  public urlBase=environment.url_api+'CcnaTipoDominio';
  ...
  public AgregarCategoria(listaPregunta: ccnaPreguntaDTO):Observable<any>{
  ...
  public ActualizarCategoria(listaPregunta: ccnaPreguntaActualizarDTO):Observable<any>{
    const formData: FormData = new FormData();
