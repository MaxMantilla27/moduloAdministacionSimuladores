...
import { ccnaActualizarTareaDTO, ccnaAgregarTareaDTO } from 'src/app/Models/Ccna/CcnaTareaDTO';
import { environment } from 'src/environments/environment';

@Injectable({
  providedIn: 'root'
})
export class CcnaTareaService {

  public urlBase=environment.url_api+'CcnaTarea';
  ...
  public AgregarSubCategoria(listaPregunta: ccnaAgregarTareaDTO):Observable<any>{
  ...
  public ActualizarSubCategoria(listaPregunta: ccnaActualizarTareaDTO):Observable<any>{
    const formData: FormData = new FormData();
