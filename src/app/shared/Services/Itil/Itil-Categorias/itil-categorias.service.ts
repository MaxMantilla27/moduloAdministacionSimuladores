...
export class ItilCategoriasService {

  public urlBase=environment.url_api+'ItilTipoDominio';
  ...
  public AgregarCategoria(listaPregunta: ItilPreguntaDTO):Observable<any>{
  ...
  public ActualizarCategoria(listaPregunta: ItilPreguntaActualizarDTO):Observable<any>{
    const formData: FormData = new FormData();
