...
export class TogTareaService {

  public urlBase=environment.url_api+'TogTarea';
  ...
  public AgregarSubCategoria(listaPregunta: TogAgregarTareaDTO):Observable<any>{
  ...
  public ActualizarSubCategoria(listaPregunta: TogActualizarTareaDTO):Observable<any>{
    const formData: FormData = new FormData();
